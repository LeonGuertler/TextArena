...
class EnglishDictionary:
    ...
    def _load_dic(
        ...
        with (
            importlib.resources.files("textarena.data")
            .joinpath(filename)
            .open("r") as f
        ):
...
if __name__ == "__main__":
    ...
    print(dict.is_english_word("worlds"))
    print(dict.is_english_word("worldly"))
    print(dict.is_english_word("worldliness"))
    print(dict.is_english_word("worldlinessesest"))
    print(dict.is_english_word("rewilding"))
    print(dict.is_english_word("reviews"))
    print(dict.is_english_word("skies"))
    print(dict.is_english_word("golds"))
    print(dict.is_english_word("hits"))
