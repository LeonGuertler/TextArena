...
class ConnectFourEnv(ta.Env):
    ...
    def reset(self, num_players: int, seed: Optional[int] = None, player_prompt_function=None):
        self._custom_prompt_fn = player_prompt_function
    ...
    def _generate_player_prompt(self, player_id: int, game_state: Dict[int, Any]) -> str:
        if self._custom_prompt_fn is not None:
            # Use custom one if supplied at reset
            return self._custom_prompt_fn(player_id, game_state)
